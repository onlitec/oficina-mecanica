...
echo "   🏠 Interface Web: http://toledooficina.local/"
echo "   🔧 API: http://toledooficina.local/api"
echo "   🏥 Health Check: http://toledooficina.local/health"
echo "   👥 Usuários: http://toledooficina.local/api/users"
echo "   🏢 Clientes: http://toledooficina.local/api/customers"
echo ""
